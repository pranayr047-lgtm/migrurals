      ...
      <div className="flex min-h-[calc(100vh-160px)] items-center justify-center px-4">
        ...
        >
          ...
          <button
            ...
            className="flex w-full items-center justify-center gap-3 rounded-xl border border-border bg-card px-4 py-3 text-sm font-medium text-foreground shadow-sm transition-all hover:bg-muted hover:shadow-md"
          >
